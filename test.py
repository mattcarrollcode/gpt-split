...
class TestSplitOnNTokens(unittest.TestCase):
    ...
    def test_first_chuck_token_size(self):
        text = "hello I'm marcy"
        enc = tiktoken.encoding_for_model("gpt-4")
        result = split_on_n_tokens(text, 3, enc)
        encoded_first_chunk = enc.encode(result[0])
        self.assertEqual(len(encoded_first_chunk), 3)
